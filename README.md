...
Acquistare:
 <img src="http://yuml.me/diagram/scruffy/usecase/[Utente]-(Acquista Unità Centrale ed Adattori), (Acquista Unità Centrale ed Adattori)>(Autenticazione), [Utente]-(Acquista Abbonamento), (Acquisto Abbonamento)>(Scegliere Livello Abbonamento), (Acquisto Unità Centrale ed Adattatori)>(Pagamento), (Acquisto Abbonamento)>(Pagamento), (Pagamento)>(Inserire Dati Pagamento), [Staff]-(Riceve Ordine), (Riceve Ordine)>(Pagamento), [Staff]-(Rifiuta Ordine), [Staff]-(Spedisce Ordine), (Spedisce Ordine)>(Imballaggio Unità Principale ed Adattatori), [Sistema Bancario]-(Accetta Pagamento), [Sistema Bancario]-(Rifiuta Pagamento), (Rifiuta Transazione)>(Comunica Errore)">
